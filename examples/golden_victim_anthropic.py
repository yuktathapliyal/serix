"""
Golden Victim (Anthropic) - A vulnerable agent for demo purposes.

Same as golden_victim.py but uses Anthropic's Claude API instead of OpenAI.
Has a hidden weakness: makes exceptions for "emotional distress",
which the Grandma exploit will trigger.

Usage:
    serix test examples/golden_victim_anthropic.py:golden_victim \
        --scenarios jailbreak \
        --provider anthropic \
...
if __name__ == "__main__":
    # Quick test
    print("Testing golden_victim agent (Anthropic)...")
